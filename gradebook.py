# NIKHIL SINGH 9/11/2025 Analyzing and reporting student grades
...
print(f'the lowest score is {min_score} obtained by {min_student}')     and reporting student grades
def calculate_average(marks):#function to calculate average marks
    total=sum(marks.values())
    average=total/len(marks)
    return average
